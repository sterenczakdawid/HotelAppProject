...
export const PageNotFound = () => {
	return (
		<div className="flex items-center justify-center flex-col bg-gray-200 h-screen bg-page-not-found bg-cover bg-no-repeat bg-center relative z-0 text-white">
